...
# ==============================================================================
# MULTI-THREADED CAMERA CLASS (FOR PI 4 & MODULE 3)
# ==============================================================================
class VideoStream:
    def __init__(self, src=0, width=640, height=480):
        # PI 4 & MODULE 3 ICIN KRITIK AYAR: cv2.CAP_V4L2
        # Bu ayar kameranin Linux driver'ini dogrudan kullanmasini saglar.
...
# ==============================================================================
# SERIAL COMMUNICATION (PICO)
# ==============================================================================
try:
    # Pi 4 uzerinde Pico genelde /dev/ttyACM0 adresindedir.
    ser = serial.Serial('/dev/ttyACM0', 115200, timeout=1)
    ser.flush()
    print("[INFO] PICO BAGLANDI - SISTEM ONLINE")
except:
    ser = None
    print("[WARNING] PICO BULUNAMADI - SIMULASYON MODU")
...
# ==============================================================================
def main():
    print("[INFO] KAMERA BASLATILIYOR...")
    try:
